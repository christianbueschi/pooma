  ...
  return (
    <>
      ...
      <StyledContent>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to pooma.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to pooma, accessible from{' '}
              <a href='pooma.app' rel='noreferrer' target='_blank'>
                pooma.app
              </a>
            </p>
          </li>
        ...
        <ul>
          <li>By email: hello@pooma.app</li>
        </ul>
      </StyledContent>
    </>
  );
